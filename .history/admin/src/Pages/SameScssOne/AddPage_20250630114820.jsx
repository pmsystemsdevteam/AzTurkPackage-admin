...
function AddPage() {
  ...
  const [loading, setLoading] = useState(false); // Fixed typo: laoding -> loading
  const [errorMessage, setErrorMessage] = useState("");
  const [look, setLook] = useState(true); // Default price visibility to true
  const [visible, setVisible] = useState(true); // Default product visibility to true
  ...
  const resetForm = () => {
    ...
    setPrice("");
    setImage(null);
    setLook(true); // Reset to true
    setVisible(true); // Reset to true
    setErrorMessage("");
  };
  ...
  const handleFormSubmit = async (e) => {
    ...
    // Visibility fields
    formData.append("Look", look); // Price visibility
    formData.append("Visible", visible); // Product visibility
  ...
  return (
    <div className="update-page">
      ...
      <form className="update-form" onSubmit={handleFormSubmit}>
        ...
        <div className="form-group">
          <label htmlFor="descTr">Açıqlama Imitate (TR)</label>
          <textarea
            id="descTr"
            value={descTr}
