...
function UpdatePage() {
    ...
    const fetchDetail = async () => {
      try {
        const res = await axios.get(
          `http://172.20.10.86:8000/api/packages/${id}`
        );
        const data = res.data;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`http://172.20.10.86:8000/api/packages/${id}/`, payload);
  ...
  return (
    <div className="update-page">
      ...
      <button
        type="button"
        onClick={() => toast.success("Test bildirişi!", { position: "top-right" })}
