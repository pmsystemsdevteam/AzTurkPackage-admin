...
function FoodPage() {
  ...
  const handleImageClick = (imageUrl) => setShowImage(imageUrl);
  ...
  const filteredFoods = product
    ...
    .sort((a, b) => {
      if (sortOrder === "az") {
        ...
        return b.Type?.Az.localeCompare(b.Type?.Az);
      }
      return 0;
    });
      ...
      <table className="food-table">
        <thead>
          <tr>
            ...
            <th>Xüsusiyyət 2(AZ)</th>
            <th>Xüsusiyyət 2(TR)</th>
            <th>Xüsusiyyət 2(EN)</th>
            <th>Xüsusiyyət 3(AZ)</th>
            <th>Xüsusiyyət 3(TR)</th>
            <th>Xüsusiyyət 3(EN)</th>
            <th>Şəkil</th>
            <th>Qiymət</th>
