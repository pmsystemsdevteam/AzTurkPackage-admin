...
import featuresOneOfProduct from "../../../public/assets/features.jpg";
import featuresTwoOfProduct from "../../../public/assets/features.jpg";
import featuresThreeOfProduct from "../../../public/assets/features.jpg";
        ...
        <thead>
          <tr>
            ...
            <th>
              ...
              <span
                className="info-icon"
                onClick={() => openImageModal(featuresOfProduct)}
              >
                i
              </span>
            </th>
            <th>
              ...
              <span
                className="info-icon"
                onClick={() => openImageModal(infoIcon1)}
              >
                i
              </span>
            </th>
            <th>
              ...
              <span
                className="info-icon"
                onClick={() => openImageModal(infoIcon2)}
              >
                i
              </span>
            </th>
            <th>
              ...
              <span
                className="info-icon"
                onClick={() => openImageModal(infoIcon3)}
              >
                i
              </span>
            </th>
