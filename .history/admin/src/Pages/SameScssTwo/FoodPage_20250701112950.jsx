...
import typeOfProduct from "../../../public/assets/type.jpg";
import descriptionOfProduct from "../../../public/assets/description.jpg";
import featuresOneOfProduct from "../../../public/assets/featuresOne.jpg";
import featuresTwoOfProduct from "../../../public/assets/featuresTwo.jpg";
import featuresThreeOfProduct from "../../../public/assets/featuresThree.jpg";
import nameOfProduct from "../../../public/assets/name.jpg";
        ...
        <thead>
          <tr>
            ...
            <th>
              ...
              <span
                className="info-icon"
                onClick={() => openImageModal(nameOfProduct)}
              >
                <i>
                  <IoIosInformationCircleOutline />
                </i>
            ...
            <th>
              ...
              <span
                className="info-icon"
                onClick={() => openImageModal(typeOfProduct)}
              >
                <i>
                  <IoIosInformationCircleOutline />
                </i>
            ...
            <th>
              ...
              <span
                className="info-icon"
                onClick={() => openImageModal(descriptionOfProduct)}
              >
                <i>
                  <IoIosInformationCircleOutline />
                </i>
            ...
            <th>
              ...
              <span
                className="info-icon"
                onClick={() => openImageModal(featuresOneOfProduct)}
              >
                <i>
                  <IoIosInformationCircleOutline />
                </i>
            ...
            <th>
              ...
              <span
                className="info-icon"
                onClick={() => openImageModal(featuresTwoOfProduct)}
              >
                <i>
                  <IoIosInformationCircleOutline />
                </i>
            ...
            <th>
              ...
              <span
                className="info-icon"
                onClick={() => openImageModal(featuresThreeOfProduct)}
              >
               <i>
                  <IoIosInformationCircleOutline />
                </i>
