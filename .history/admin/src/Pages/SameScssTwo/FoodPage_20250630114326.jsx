...
function FoodPage() {
  ...
  const [sortOrder, setSortOrder] = useState("priceVisible"); // Default to price visible
  ...
  const filteredFoods = product
    ...
    .sort((a, b) => {
      if (sortOrder === "priceVisible") {
        // Sort by Look: true first
        return b.Look - a.Look; // true (1) comes before false (0)
      ...
      <div className="header-row">
        ...
        <div className="sort-filter">
          <select id="sort" value={sortOrder} onChange={handleSortChange}>
            ...
            <option value="priceVisible">Qiymət Görünən</option>
