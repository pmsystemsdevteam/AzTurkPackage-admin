    ...
    <div className="food-page">
      ...
      <div className="header-row">
        ...
        <div className="add-food-button">
          ...
          <button onClick={downloadPDF} style={{ marginLeft: "10px", backgroundColor: "#ff9800" }}>
            PDF olaraq yüklə
          </button>
        </div>
      </div>
...
1.5s
Interrupted
excel olarak olsun fikrimi degistim pdf olmasin excel olsun




Here's the modified code to add a button for downloading the product table as an Excel file using the xlsx library. The code replaces the PDF functionality with Excel export, keeping all other functionality intact.

First, ensure you install the required library:
  ...
  return (
    <div className="food-page">
      ...
      <div className="header-row">
        ...
        <div className="add-food-button">
          <button onClick={handleAddFood}>Yeni Məhsul Əlavə Et</button>
          <button onClick={downloadExcel} style={{ marginLeft: "10px", backgroundColor: "#4caf50" }}>
            Excel olaraq yüklə
          </button>
        </div>
      </div>
